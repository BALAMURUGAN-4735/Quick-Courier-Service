...
/* 👇 MOBILE FIXES: Huge margins reset for phones 👇 */
@media screen and (max-width: 768px) {
    ...
    .aboutus {
        height: auto !important; /* Mobile-la content cut aagama irukka */
    ...
    .aboutus img.a {
        width: 100% !important; /* Image screen-ah udaiyama irukka */
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">  <div class="carousel-indicators">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="Images/courier_image_5.jpg" class="d-block" width="100%" height="400px" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/courier_image_6.jpg" class="d-block" width="100%" height="400px" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/courier_image_7.jpg" class="d-block" width="100%" height="400px" alt="...">
    </div>
	  <div class="carousel-item">
      <img src="Images/courier_image_8.jpg" class="d-block" width="100%" height="400px" alt="...">
    </div>
  </div>
	...
	<!-- Grid column -->
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled mb-0">
          ...
          <li>
            <a href="index.php" class="text-white">Booking</a>
          </li>
          <li>
